...
const JobPage = () => {
    ...
    if (!job) {
        return <div className="text-center mt-8 text-xl">Job not found 😢</div>;
    }
        ...
        <div className="flex flex-col gap-8 mt-5">
            ...
            {job?.recruiter === user?.id &&
                <Select onValueChange={handleStatusChange}>
                    <SelectTrigger
                        className={`w-full text-white shadow-none bg-opacity-90 ${job?.isOpen ? "!bg-green-900" : " !bg-red-900"
                            }`}
                    >
            ...
            {job?.applications?.length > 0 && job?.recruiter === user?.id && (
